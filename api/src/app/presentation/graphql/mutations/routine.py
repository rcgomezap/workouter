...
class RoutineMutation:
    @strawberry.mutation
    async def create_routine(self, info: Info[Context, None], input: CreateRoutineInput) -> Routine:
    ...
    async def update_routine(
        self, info: Info[Context, None], id: UUID, input: UpdateRoutineInput
    ) -> Routine:
    ...
    async def add_routine_exercise(
        self, info: Info[Context, None], routine_id: UUID, input: AddRoutineExerciseInput
    ) -> Routine:
    ...
    async def update_routine_exercise(
        self, info: Info[Context, None], id: UUID, input: UpdateRoutineExerciseInput
    ) -> RoutineExercise:
    ...
    async def add_routine_set(
        self, info: Info[Context, None], routine_exercise_id: UUID, input: AddRoutineSetInput
    ) -> RoutineExercise:
    ...
    async def update_routine_set(
        self, info: Info[Context, None], id: UUID, input: UpdateRoutineSetInput
    ) -> RoutineSet:
