...
def map_progressive_overload_insight(p) -> ProgressiveOverloadInsight:
    return ProgressiveOverloadInsight(
        ...
        weekly_progress=[WeeklyExerciseProgress(
...
class InsightQuery:
    ...
    async def progressive_overload_insight(
        ...
        p = await info.context.insight_service.get_progressive_overload_insight(mesocycle_id, exercise_id)
